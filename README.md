...
It uses the Strimzi container images and is currently based on Strimzi 0.51.0 / Apache Kafka 4.2.0.
As Kafka 4.x does not support ZooKeeper anymore, there is only a KRaft based compose file.
