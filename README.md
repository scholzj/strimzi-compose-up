...
It uses the Strimzi container images and is currently based on Strimzi 0.48.0 / Apache Kafka 4.1.0.
As Kafka 4.1.0 does not support ZooKeeper anymore, there is only a KRaft based compose file.
